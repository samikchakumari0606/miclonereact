...
const Navbar = () => {
  return (
    <div className='nav'>
        <div className="logo">
        <Link to="/"><img id="logoImage" src="https://i01.appmifile.com/webfile/globalimg/pandora/mi-logo.svg" alt="Not" /></Link>
           ...
           <Link  className="navlinks" to="/#lapto=ps">Laptops</Link>
